...
class  AdminStats extends BaseWidget
{
    protected function getStats(): array
    {
        ...
        $fee = ReportClass::where('month', '01-2026')->sum('fee_student');
        $feeFormatted = 'RM' . number_format($fee, 2); // Format the allowance

        $allowance = ReportClass::where('month', '01-2026')->sum('allowance');
        ...
        return [
            Stat::make('Jumlah Yuran Bulan Januari 26', $feeFormatted )
            ...
            Stat::make('Jumlah Elaun Bulan Januari 26',   $allowanceFormatted)
            ->extraAttributes([ 
                // 'wire:click' => '$emit("filterUpdate", "is_admin")',
            ...
            Stat::make('Baki Yuran Belum Bayar Januari 26', $overdueFormatted)
            ->extraAttributes([ 
                // 'wire:click' => '$emit("filterUpdate", "is_admin")',
