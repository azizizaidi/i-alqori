...
class  AdminStats extends BaseWidget
{
    protected function getStats(): array
    {
        ...
        $fee = ReportClass::where('month', '07-2025')->sum('fee_student');
        ...
        return [
            Stat::make('Jumlah Yuran Bulan Julai 25', $feeFormatted )
            ...
            Stat::make('Jumlah Elaun Bulan Julai 25',   $allowanceFormatted)
            ->extraAttributes([ 
                // 'wire:click' => '$emit("filterUpdate", "is_admin")',
            ...
            Stat::make('Baki Yuran Belum Bayar Julai 25', $overdueFormatted)
            ->extraAttributes([ 
                // 'wire:click' => '$emit("filterUpdate", "is_admin")',
